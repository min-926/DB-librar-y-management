...
<?php include('navbar_books.php'); $connection = mysqli_connect("localhost", "root", "", "eb_lms") or die("Connection failed: " . mysqli_connect_error());?>
    <div class="container">
						...
						<h1>Old Books</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($connection,"select * from book where status = 'old'")or die(mysqli_error($connection));
