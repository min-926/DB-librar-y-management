      ...
      <div class="nav-collapse collapse">
        <ul class="nav">
          ...
          <?php if (!isset($_SESSION['id'])): ?>
            <li>
              <a rel="tooltip" data-placement="bottom" title="Click Here to Login" href="librarian">Staff </a>
            </li>
            
            <li>
            <a rel="tooltip" data-placement="bottom" title="Click Here to Login" href="admin_login.php">Administrator </a>
